...
import { LayoutDashboard, ClipboardList, PlusCircle, User, HeadphonesIcon, LogOut, Wrench } from "lucide-react";
...
export default function CustomerLayout({ children }: { children: React.ReactNode }) {
  ...
  const newOfferCount = notifs.filter((n) => !n.isRead && n.type === "new_offer").length;
  ...
  const navItems = [
    ...
    { href: "/customer/requests",     icon: ClipboardList,   label: "طلباتي",        badge: newOfferCount },
